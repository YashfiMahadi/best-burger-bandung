                    ...
                    <div class="card">
                        <div class="card-header border-bottom">
                            <div class="col-md-12 p-0 text-right">
                                <a href="/kategori/tambah" class="btn btn-success">
                                    Tambah data
                                </a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/kategori/{{ $item->id }}/delete" class="btn btn-danger" onclick="return confirm('apakah anda yakin ingin menghapusnya?');">hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
